...
class EmailTemplate {
    public static function EmailFormat($name, $email, $message,$subject) {
        return '<!DOCTYPE html>
...
$mail->setFrom('thamoddya.smtp@gmail.com', 'Codiffy LK');
$mail->addReplyTo($email, $name);
$mail->addAddress("codiffylk@gmail.com");
$mail->isHTML(true);
$mail->Subject = 'Codiffy LK | Contact Message';
$mail->Body = EmailTemplate::EmailFormat($name, $email, $message,$subject);
